(function (global, factory) {
            ...
            function wrapNode(node, destinationIsFixed, postClone, appendToBody) {
            	...
            	var clone = postClone(cloneNode(node));
            ...
            var ramjet = {
            	transform: function (fromNode, toNode) {
            		...
            		var postClone = options.postClone ? options.postClone : function (n) {
            			return n;
            		};
            		var destinationIsFixed = isNodeFixed(toNode);
            		var from = wrapNode(fromNode, destinationIsFixed, postClone, appendToBody);
            		var to = wrapNode(toNode, destinationIsFixed, postClone, appendToBody);
